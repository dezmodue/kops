...
type WarmPoolSpec struct {
	...
	// WarmPoolExtraImages is a list of extra container images to pull into the warm pool instances.
	WarmPoolExtraImages []string `json:"warmPoolExtraImages,omitempty"`
}
